...
#define NUMBER_OF_CONFIGURATION_ENTRIES 18

#define EEPROM_VERSION              0
#define EEPROM_USE_RC               1
#define EEPROM_RC_STEERING_MIN      2
#define EEPROM_RC_STEERING_CENTER   3
#define EEPROM_RC_STEERING_MAX      4
#define EEPROM_RC_THROTTLE_MIN      5
#define EEPROM_RC_THROTTLE_CENTER   6
#define EEPROM_RC_THROTTLE_MAX      7
#define EEPROM_USE_PWM_JOYSTICK_X   8
#define EEPROM_USE_PWM_JOYSTICK_Y   9
#define EEPROM_INVERT_JOYSTICK_X    10
#define EEPROM_INVERT_JOYSTICK_Y    11
#define EEPROM_JOYSTICK_STEERING_MIN    12
#define EEPROM_JOYSTICK_STEERING_CENTER 13
#define EEPROM_JOYSTICK_STEERING_MAX    14
#define EEPROM_JOYSTICK_THROTTLE_MIN    15
#define EEPROM_JOYSTICK_THROTTLE_CENTER 16
#define EEPROM_JOYSTICK_THROTTLE_MAX    17
...
ConfigurationEntry configurationEntries[] = {
  ...
  {"Invert Joystick X", 56, BOOLEAN_CONFIGURATION, false, 0},
  {"Invert Joystick Y", 60, BOOLEAN_CONFIGURATION, false, 0},
