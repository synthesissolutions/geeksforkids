...
const String        RELEASE_VERSION         = "24.4 w/Lockout";
...
const int           PIN_RC_STEERING               = 17; // RC Channel 1
const int           PIN_RC_THROTTLE               = 19; // RC Channel 2
const int           PIN_RC_LOCKOUT                = 0;  // RC Channel 3
