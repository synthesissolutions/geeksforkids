...
GPIO.setup(photoresistor, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
GPIO.setup(front_LED_bar, GPIO.OUT)
...
GPIO.output(front_LED_bar, GPIO.LOW)
...
def carOutput(gaze):
    ...
    if gaze_out < far_left_cal:
        ...
        gaze_out = 100
    #sets center drive to a gaze range to prevent veering when looking straight (will vary depending on linear actuator placement)
    elif gaze_out > 43.5 and gaze_out < 53.5:
        gaze_out = 47.5
    ...
    #print(gaze_out)
    drive.change_duty_cycle(70)         #speed output of car (0 = stopped, 100 = 4 mph)
...
def switch_lights():
    ...
    if light_level == GPIO.HIGH:
        ...
        GPIO.output(front_LED_bar, GPIO.HIGH)
        #print("on")
...
#captures MediaPipe facial landmarks
def captureLandmarks():
    ...
    for facial_landmarks in results.multi_face_landmarks:
        ...
        #draws all tracking 4 landmarks
